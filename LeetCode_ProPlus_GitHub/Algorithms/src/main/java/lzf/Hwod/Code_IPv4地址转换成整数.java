...
/**
 * http://dl2.kerwin.cn:8063/csdn/key/article-qq_34465338-125050489/auth/1657361777-2022110618161673-0-57e7c5c54153e943acda6be4ac26507f
 ...
 */
public class Code_IPv4地址转换成整数 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        /*long count1 = 128;
        int count2 = 24;
        System.out.println(count1<<count2);//2147483648*/
        //        String[] strings = {"128","199", "231", "44"};

        String[] strings = sc.nextLine().split("#");
        int len = strings.length;
        long count = 0; //需要用long类型,如果是int类型，128向左移24位会变成-2147483648
        boolean isF = true;
